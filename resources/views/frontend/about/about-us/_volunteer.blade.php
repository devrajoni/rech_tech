<section class="volunteer padding-tb" style="background-image: url("{{ asset('frontend/assets/css/images/volunteer-bg.jpg') }}"); background-size: cover;">
    <div class="container">
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="post-item">
                            <div class="post-inner">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{ asset('frontend/assets/images/volunteer/01.jpg') }}" alt="volunteer"></a>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="post-item">
                            <div class="post-inner">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{ asset('frontend/assets/images/volunteer/02.jpg') }}" alt="volunteer"></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-header">
                    ...
                    <div class="swiper-slide">
                        <div class="post-item">
                            <div class="post-inner">
                                <div class="post-thumb">
                                    <a href="#"><img src="{{ asset('frontend/assets/images/volunteer/03.jpg') }}" alt="volunteer"></a>
                                </div>
                                <div class="post-content">
                                    <div class="post-header">
