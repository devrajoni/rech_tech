                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="box-office">
                            <img src="{{ asset('frontend/assets/img/shortcode/contact/office-1.jpg') }}" alt="Image">
                    ...
                    <div class="col-md-3">
                        <div class="box-office">
                            <img src="{{ asset('frontend/assets/img/shortcode/contact/office-2.jpg')}}" alt="Image">
                    ...
                    <div class="col-md-3">
                        <div class="box-office">
                            <img src="{{ asset('frontend/assets/img/shortcode/contact/office-3.jpg') }}" alt="Image">
                            <h3 class="title-office">Asia Office</h3>
                            <p class="infor-office style-2">1935 Providence Lane Arcadia, CA 91006</p>
                            <a class="btn-view" href="#">View on Map</a>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="box-office">
                            <img src="{{ asset('frontend/assets/img/shortcode/contact/office-4.jpg') }}" alt="Image">
