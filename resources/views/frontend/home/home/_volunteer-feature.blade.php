...
<div class="container">
    ...
    <div class="section-wrapper">
        <div class="post-item" data-aos="fade-left" data-aos-duration="700">
            <div class="post-inner">
                <div class="post-thumb">
                    <img src="{{ asset('frontend/assets/images/feature/png/01.png') }}" alt="feature">
                </div>
        ...
        <div class="post-item" data-aos="fade-up" data-aos-duration="700">
            <div class="post-inner">
                <div class="post-thumb">
                    <img src="{{ asset('frontend/assets/images/feature/png/02.png') }}" alt="feature">
                </div>
                <div class="post-content">
                    <h4>Solar System</h4>
                    <p>Cabors Levera Othns Andn That Quas Bwdh Thos Covae Theme Any Value Cordnte.</p>
        ...
        <div class="post-item" data-aos="fade-down" data-aos-duration="700">
            <div class="post-inner">
                <div class="post-thumb">
                    <img src="{{ asset('frontend/assets/images/feature/png/03.png') }}" alt="feature">
                </div>
                <div class="post-content">
                    <h4>Eco System</h4>
                    <p>Cabors Levera Othns Andn That Quas Bwdh Thos Covae Theme Any Value Cordnte.</p>
        ...
        <div class="post-item" data-aos="fade-right" data-aos-duration="700">
            <div class="post-inner">
                <div class="post-thumb">
                    <img src="{{ asset('frontend/assets/images/feature/png/04.png') }}" alt="feature">
                </div>
                <div class="post-content">
                    <h4>Recycling</h4>
                    <p>Cabors Levera Othns Andn That Quas Bwdh Thos Covae Theme Any Value Cordnte.</p>
