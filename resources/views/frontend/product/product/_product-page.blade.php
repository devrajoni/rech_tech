            ...
            <div class="col-lg-9 col-12 sticky-widget">
                ...
                <div class="shop-product-wrap grid row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="product-item">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend/assets/images/shope/05.jpg') }}" alt="shope">
                                <div class="product-action-link">
                                    <a class="view-modal" data-target="#quick_view"><i class="far fa-eye"></i></a>
                                    <a href="#"><i class="far fa-heart"></i></a>
                                    <a href="#"><i class="fas fa-cart-plus"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="product-item">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend/assets/images/shope/06.jpg') }}" alt="shope">
                                <div class="product-action-link">
                                    <a class="view-modal" data-target="#quick_view"><i class="far fa-eye"></i></a>
                                    <a href="#"><i class="far fa-heart"></i></a>
                                    <a href="#"><i class="fas fa-cart-plus"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="product-item">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend/assets/images/shope/07.jpg') }}" alt="shope">
                                <div class="product-action-link">
                                    <a class="view-modal" data-target="#quick_view"><i class="far fa-eye"></i></a>
                                    <a href="#"><i class="far fa-heart"></i></a>
                                    <a href="#"><i class="fas fa-cart-plus"></i></a>
