                    ...
                    <div class="col-auto">
                        ...
                        <ul class="header-notification-area">
                            ...
                            <li class="adomx-dropdown position-relative col-auto">
                                <a class="toggle" href="#"><img class="lang-flag" src="{{ asset('backend/assets/images/flags/flag-1.jpg') }}" alt=""><i class="zmdi zmdi-caret-down drop-arrow"></i></a>

                                <!-- Dropdown -->
                                <ul class="adomx-dropdown-menu dropdown-menu-language">
                                    <li><a href="#"><img src="{{ asset('backend/assets/images/flags/flag-1.jpg') }}" alt=""> English</a></li>
                                    <li><a href="#"><img src="{{ asset('backend/assets/images/flags/flag-2.jpg') }}" alt=""> Japanese</a></li>
                                    <li><a href="#"><img src="{{ asset('backend/assets/images/flags/flag-3.jpg') }}" alt=""> Spanish </a></li>
                                    <li><a href="#"><img src="{{ asset('backend/assets/images/flags/flag-4.jpg') }}" alt=""> Germany</a></li>
                                </ul>
                                ...
                                <div class="adomx-dropdown-menu dropdown-menu-mail">
                                    ...
                                    <div class="body custom-scroll">
                                        <ul>
                                            <li>
                                                <a href="#">
                                                    <div class="image"><img src="{{ asset('backend/assets/images/avatar/avatar-2.jpg') }}" alt=""></div>
                                                    <div class="content">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="image"><img src="{{ asset('backend/assets/images/avatar/avatar-1.jpg') }}" alt=""></div>
                                                    <div class="content">
