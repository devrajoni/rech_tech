                            ...
                            <table class="table table-vertical-middle table-selectable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('backend/assets/images/product/list-product-1.jpg') }}" alt="" class="table-product-image rounded-circle"></td>
                                    ...
                                    <tr class="selected">
                                        <td class="selector"><label class="adomx-checkbox"><input type="checkbox"> <i class="icon"></i></label></td>
                                        <td><img src="{{ asset('backend/assets/images/product/list-product-2.jpg') }}" alt="" class="table-product-image rounded-circle"></td>
                                        <td><a href="#">Microsoft surface pro 4</a></td>
                                        <td>#MSP40022</td>
                                        <td>05 - Products</td>
                                        <td>$60000000.00</td>
                                    ...
                                    <tr>
                                        <td class="selector"><label class="adomx-checkbox"><input type="checkbox"> <i class="icon"></i></label></td>
                                        <td><img src="{{ asset('backend/assets/images/product/list-product-3.jpg') }}" alt="" class="table-product-image rounded-circle"></td>
                                        <td><a href="#">Microsoft surface pro 4</a></td>
                                        <td>#MSP40022</td>
                                        <td>05 - Products</td>
                                        <td>$60000000.00</td>
                                    ...
                                    <tr>
                                        <td class="selector"><label class="adomx-checkbox"><input type="checkbox"> <i class="icon"></i></label></td>
                                        <td><img src="{{ asset('backend/assets/images/product/list-product-4.jpg') }}" alt="" class="table-product-image rounded-circle"></td>
                                        <td><a href="#">Microsoft surface pro 4</a></td>
                                        <td>#MSP40022</td>
                                        <td>05 - Products</td>
                                        <td>$60000000.00</td>
                            ...
                            <ul class="widget-chat-list">
                                <li>
                                    <div class="widget-chat">
                                        ...
                                        <div class="body">
                                            <div class="image"><img src="{{ asset('backend/assets/images/comment/comment-1.jpg') }}" alt=""></div>
                                            <div class="content">
                                ...
                                <li>
                                    <div class="widget-chat">
                                        ...
                                        <div class="body">
                                            <div class="image"><img src="{{ asset('backend/assets/images/comment/comment-2.jpg') }}" alt=""></div>
                                            <div class="content">
                                ...
                                <li>
                                    <div class="widget-chat">
                                        ...
                                        <div class="body">
                                            <div class="image"><img src="{{ asset('backend/assets/images/comment/comment-3.jpg') }}" alt=""></div>
                                            <div class="content">
